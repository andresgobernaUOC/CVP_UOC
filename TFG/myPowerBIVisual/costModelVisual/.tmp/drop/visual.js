var costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
/* harmony export */   eH: () => (/* reexport safe */ _axis_js__WEBPACK_IMPORTED_MODULE_0__.eH),
...
/* harmony export */   Wcw: () => (/* reexport safe */ d3_shape__WEBPACK_IMPORTED_MODULE_5__.Wc),
/* harmony export */   eH3: () => (/* reexport safe */ d3_axis__WEBPACK_IMPORTED_MODULE_1__.eH),
/* harmony export */   hqK: () => (/* reexport safe */ d3_scale__WEBPACK_IMPORTED_MODULE_3__.hq),
...
/* harmony export */   nVG: () => (/* reexport safe */ d3_shape__WEBPACK_IMPORTED_MODULE_5__.nV),
/* harmony export */   t$z: () => (/* reexport safe */ d3_shape__WEBPACK_IMPORTED_MODULE_5__.t$)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hq: () => (/* reexport safe */ _band_js__WEBPACK_IMPORTED_MODULE_0__.z),
...
/* harmony export */   jk: () => (/* reexport safe */ _min_js__WEBPACK_IMPORTED_MODULE_1__.A)
/* harmony export */ });
/* harmony import */ var _max_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(846);
/* harmony import */ var _min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9216);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ point)
/* harmony export */ });
...
/* harmony import */ var _line_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8640);
...
/* harmony export */   eH: () => (/* binding */ axisRight),
...
class Visual {
    ...
    update(options) {
        d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv(this.target).selectAll("*").remove();
        const width = options.viewport.width;
        const height = options.viewport.height;
        const margin = { top: 40, right: 80, bottom: 80, left: 80 };
        const innerWidth = width - margin.left - margin.right;
        const innerHeight = height - margin.top - margin.bottom;
        const svg = d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv(this.target)
            .append("svg")
            .attr("width", width)
            .attr("height", height)
            .append("g")
        ...
        // Extract categories
        const cyValues = categorical.categories.find(c => c.source.roles["CY"])?.values || [];
        const qValues = categorical.categories.find(c => c.source.roles["Q"])?.values || [];
        const monthValues = categorical.categories.find(c => c.source.roles["month"])?.values || [];
        const monthOrderValues = categorical.categories.find(c => c.source.roles["monthOrder"])?.values || [];
        // Extract measures
        const fixCostValues = categorical.values.find(v => v.source.roles["fixCost"])?.values || [];
        const varCostValues = categorical.values.find(v => v.source.roles["varCost"])?.values || [];
        const costDriverValues = categorical.values.find(v => v.source.roles["costDriverInput"])?.values || [];
        const varUnitCostValues = categorical.values.find(v => v.source.roles["modVarUnitCost"])?.values || [];
        ...
        function extractSingleMeasure(roleName) {
            ...
            switch (roleName) {
                case "fixCostMin":
                    return d3__WEBPACK_IMPORTED_MODULE_0__/* .min */ .jkA(vals) || 0;
                case "fixCostMax":
                    return d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(vals) || 0;
                case "fixCostMedian":
        ...
        const x = d3__WEBPACK_IMPORTED_MODULE_0__/* .scalePoint */ .hqK()
            .domain(xDomain)
            .range([0, innerWidth])
            .padding(0.5);
        // Y scale for stacked costs
        const maxYValue = d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B([
            d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(data, d => d.fixCost + d.varCost) || 0,
            fixCostMedian,
            fixCostMin,
            fixCostMax
        ]) || 0;
        const yLeft = d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .m4Y()
            .domain([0, maxYValue])
            .nice()
            .range([innerHeight, 0]);
        // Y scale for costDriver (volume) on secondary axis
        const maxCostDriver = d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(data, d => d.costDriver) || 0;
        const yRight = d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .m4Y()
            .domain([0, maxCostDriver])
            .nice()
            .range([innerHeight, 0]);
        // Y scale for varUnitCost (third axis)
        const maxVarUnitCost = d3__WEBPACK_IMPORTED_MODULE_0__/* .max */ .T9B(data, d => d.varUnitCost) || 0;
        const yRightVarUnit = d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .m4Y()
            .domain([0, maxVarUnitCost])
            .nice()
            .range([innerHeight, 0]);
        // D3 stack generator for fixCost and varCost
        const stack = d3__WEBPACK_IMPORTED_MODULE_0__/* .stack */ .t$z()
            .keys(["fixCost", "varCost"]);
        const series = stack(data);
        // Area generator for stacked areas
        const area = d3__WEBPACK_IMPORTED_MODULE_0__/* .area */ .Wcw()
            .x(d => {
            ...
            .y0(d => yLeft(d[0]))
            .y1(d => yLeft(d[1]))
            .curve(d3__WEBPACK_IMPORTED_MODULE_0__/* .curveMonotoneX */ .nVG);
        ...
        const lineCostDriver = d3__WEBPACK_IMPORTED_MODULE_0__/* .line */ .n8j()
            .x(d => {
        ...
        const lineVarUnitCost = d3__WEBPACK_IMPORTED_MODULE_0__/* .line */ .n8j()
            .x(d => {
            const xVal = x(d.category);
            return xVal !== undefined ? xVal : 0;
        })
        ...
        svg.append("g")
            ...
            .call(d3__WEBPACK_IMPORTED_MODULE_0__/* .axisBottom */ .l78(x))
            .selectAll("text")
        ...
        svg.append("g")
            .call(d3__WEBPACK_IMPORTED_MODULE_0__/* .axisLeft */ .V4s(yLeft))
            .selectAll("text")
            .style("font-size", "9px")
            .style("fill", "white");
        ...
        svg.append("g")
            ...
            .call(d3__WEBPACK_IMPORTED_MODULE_0__/* .axisRight */ .eH3(yRight))
            .selectAll("text")
            .style("font-size", "9px")
            .style("fill", "white");
        ...
        svg.append("g")
            ...
            .call(d3__WEBPACK_IMPORTED_MODULE_0__/* .axisRight */ .eH3(yRightVarUnit))
            .selectAll("text")
            .style("font-size", "9px")
            .style("fill", "white");
        // Axis titles
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Wc: () => (/* reexport safe */ _area_js__WEBPACK_IMPORTED_MODULE_0__.A),
/* harmony export */   n8: () => (/* reexport safe */ _line_js__WEBPACK_IMPORTED_MODULE_1__.A),
/* harmony export */   nV: () => (/* reexport safe */ _curve_monotone_js__WEBPACK_IMPORTED_MODULE_2__.G),
/* harmony export */   t$: () => (/* reexport safe */ _stack_js__WEBPACK_IMPORTED_MODULE_3__.A)
/* harmony export */ });
/* harmony import */ var _area_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4439);
/* harmony import */ var _line_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8640);
/* harmony import */ var _curve_monotone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1253);
/* harmony import */ var _stack_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8872);
...
/* harmony export */   A: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _array_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5917);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8946);
/* harmony import */ var _offset_none_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3414);
/* harmony import */ var _order_none_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4873);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var keys = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)([]),
      order = _order_none_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,
      offset = _offset_none_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,
      value = stackValue;
  ...
  function stack(data) {
    ...
    for (i = 0, oz = (0,_array_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(order(sz)); i < n; ++i) {
      sz[oz[i]].index = i;
    }
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(Array.from(_)), stack) : keys;
  };

  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(+_), stack) : value;
  };

  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? _order_none_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A : typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(Array.from(_)), stack) : order;
  };

  stack.offset = function(_) {
    return arguments.length ? (offset = _ == null ? _offset_none_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A : _, stack) : offset;
  };
...
// This entry needs to be wrapped in an IIFE because it declares 'costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG' on top-level, which conflicts with the current library output.
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (visualPlugin)
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6024);

var powerbiKey = "powerbi";
var powerbi = window[powerbiKey];
var costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG = {
    name: 'costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG',
    displayName: 'costModelVisual',
    class: 'Visual',
    apiVersion: '5.3.0',
    create: (options) => {
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG"] = costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG;
}
/* harmony default export */ const visualPlugin = (costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG);

})();

costModelVisualCC57A86EE3354662871A1724816ABEF2_DEBUG = __webpack_exports__;
/******/ })()
;
